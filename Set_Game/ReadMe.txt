================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: Set_Game-Projektübersicht
===============================================================================

Diese Set_Game-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Set_Game-Anwendung besteht.
...
Set_Game.h
    ...
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CSet_GameApp-Anwendungsklasse.

Set_Game.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CSet_GameApp enthält.
...
res\Set_Game.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei Set_Game.rc enthalten.
...
Set_GameDlg.h, Set_GameDlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CSet_GameDlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in Set_Game.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Set_Game.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
