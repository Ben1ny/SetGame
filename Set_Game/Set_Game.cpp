...
// Set_Game.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CSet_GameApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CSet_GameApp-Erstellung

CSet_GameApp::CSet_GameApp()
{
...
// Das einzige CSet_GameApp-Objekt

CSet_GameApp theApp;


// CSet_GameApp-Initialisierung

BOOL CSet_GameApp::InitInstance()
{
